...
function create() {
  ...
  // create a Physics game object
  this.physics.add.image(500, 100, 'button1');
  // create character game object
  this.player = this.physics.add.image(32, 32, 'characters', 0);
  this.player.setScale(2); //NEW

  // create bindings to the arrow keys
  this.cursors = this.input.keyboard.createCursorKeys(); //NEW

}
// im-plement function for detecting key press and updating movements
function update() {
